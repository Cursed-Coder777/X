/**
 * Search page — shows search results for a given query.
 * Reads ?q= from URL search params, fetches posts via post.search tRPC query.
 * Includes an inline search input for refining the search without leaving the page.
 * Falls back to an empty state message when no query is provided.
